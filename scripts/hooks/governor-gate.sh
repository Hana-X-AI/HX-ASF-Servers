...
# The checklist lives at governace/process/governor-verification-checklist.md
# (standing governor gate); the gate itself is manual + judgment-based and is
# enforced by the governor, not by this hook. Fail-open: exit 0 always.
set -u
...
printf 'governor-gate: before accepting %s, run the mandatory verification-checklist (governace/process/governor-verification-checklist.md) — artifact exists, receipt line, token context, secret sweep, integrity, claims-vs-live-state, boundary, completeness, honest limitations, handoff-to-Carol. A deliverable that fails any step goes back with one bounded correction.\n' "$path"
exit 0
