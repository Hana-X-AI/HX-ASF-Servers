...
| SC-05 | 24 h soak | No unexplained unload/OOM/fallback/Xid/restart loop | **DEFERRED BY OWNER** (not waived) | Owner directive 2026-08-25: M7b deferred to backlog (`governace/issue-tracking/issues.md`); AC-008/AC-016 evidence absent by decision; M8 scope adjusted accordingly — rows 40, 53 |
