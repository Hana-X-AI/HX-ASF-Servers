...
9. `governace/decisions/KDD-0013-agent-model-lanes.md` — 1 finding (Chris row formatting)
10. `governace/decisions/KDD-0014-chris-registration.md` — 2 findings (activation gate voided; D3 status conditional)
