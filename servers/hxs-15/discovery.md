...
- **Pre-work context:** target address, account, privilege and preparation state from `servers/hxs-15/pre-work-results.md`, not from collector probing
...
- **Derived context:** fleet comparisons, superlatives and interpretations combine measured facts with other server records; they are not direct measurements from hxs-15
