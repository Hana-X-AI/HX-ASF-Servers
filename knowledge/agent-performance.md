...
| James (governor) [OPEN CORRECTION 2026-08-29, labeled, append-only: the governor role is now held by Flash per AGENTS.md transition; kimi-k3 is an identity-specific model lane, not the governor. The original "kimi-k3 (governor)" row above is preserved unchanged as the historical record. Flash's governor-era defects will be tracked in this row going forward.] [OPEN CORRECTION 2026-08-30, labeled, append-only: governor persona renamed Flash → James (owner decision 2026-08-30); model lane DeepSeek V4 Flash unchanged. This row tracks the governor role — currently James.] | gates/orchestration | continuous | — | (new governor — defect baseline TBD) | n/a (self-scored) | n/a | governor transition 2026-08-29; persona renamed James 2026-08-30 |
