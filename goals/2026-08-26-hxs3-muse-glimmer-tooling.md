...
| SC-06 | Multimodal | image-input probes with projector loaded | Images consumed correctly (evidence reported; disposition per D8-class rules) | probe evidence | KK3 gate |
